...
args.det_config = 'D:/WuShuang/mmaction2-main/demo/demo_configs/faster-rcnn_r50-caffe_fpn_ms-1x_coco-person.py'  # noqa: E501
...
args.pose_config = 'D:/WuShuang/mmaction2-main/demo/demo_configs/td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'  # noqa: E501
...
def ntu_pose_extraction(vid, label_no, skip_postproc=False):
    ...
    anno['img_shape'] = (width, height)
    anno['original_shape'] = (width, height)
...
if __name__ == '__main__':
    work_dir = 'D:/WuShuang/mmaction2-main/tools/data/skeleton/data/my_video'
    type_number = 7  # 类别数
    action_filename_list = ['fallingdown', 'kicking', 'punching',  # 类别名字
                            'pushing', 'throwing', 'vomiting', 'walking']
    ...
    for process_index in range(type_number):
        ...
        for file_name in resizedvideos_file_names:
            ...
            args.output = '{}/pkl4/{}.pkl'.format(work_dir, video_name)
